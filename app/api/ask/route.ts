...
export async function GET(request: NextRequest) {
  try {
    ...
    const answer = await getAnswerFromQuestion(data, `When answering the following question pretend as if you are answering in the name of Nikola Mitic, he is the person which CV jobs and thoughts you have. If you do not have the answer simply respond with saying that you do not have the answer, do not mention context. And do not start the answer with saying "as Nikola Mitic", Question is: ${query}`)
