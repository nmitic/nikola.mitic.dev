...
import { InterviewerAITalk } from "../../../components/InterviewerAITalk/InterviewerAITalk";

const AICloneInterviewTalk = async () => {
  return <InterviewerAITalk />;
};
...
export default AICloneInterviewTalk;
